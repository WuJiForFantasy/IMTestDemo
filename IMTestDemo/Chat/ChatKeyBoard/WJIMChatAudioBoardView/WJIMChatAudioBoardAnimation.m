...
@interface WJIMChatAudioBoardAnimation ()

@property (nonatomic, strong) CAShapeLayer *circleShapeLayer;

@end

@implementation WJIMChatAudioBoardAnimation
...
- (void)setUpLayers
{
    ...
    _circleShapeLayer.fillColor = [UIColor lightGrayColor].CGColor;
